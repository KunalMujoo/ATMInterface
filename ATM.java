...
//actionListener interface is being implemented by many classes, which are dependent on a button click
...
public class ATM 
{
   ...
   // 4 buttons to press after putting pin
   ...
   //ATM constructor to initialize objects
   public ATM() 
   {
	   
      userAuthenticated = false; //true set if pin is correct
   ...
   void startlogin() 
   {
	   ...
	   screen.Mainframe.revalidate();
	   keypad.BEnter.addActionListener( check );  //takes check object as the parameter--> defined in line 74
      ...
      if (userAuthenticated)
      {
	   ...
	   //creating the main menu GUI
        ...
        //NEXT 4 ACTION LISTENERS ARE FOR THE 4 MAIN MENU OPTIONS. BALANCE, DEPOSIT, WITHDRAW, EXIT
	   ...
	   {
		// this method performs whichever transaction is chosen to be processed
       
    
                Transaction currentTransaction = null;
      
                //Transaction object contains the current transaction which is being processed
